...
> >
> > ### Background
> > Removing files from a git repository needs to be done with caution. But we have not learned yet how to tell git to track a particular file, we will learn this in the next lesson. Files that are not tracked by git can easily be removed like any other "ordinary" files with
> > ~~~
> > $ rm filename
> > ~~~
> > {: .language-bash}
