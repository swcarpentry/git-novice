...
Click on the 'HTTPS' link to change the [protocol]({% link reference.md %}#protocol) from
SSH to HTTPS.
...
> [timestamps]({% link reference.md %}#timestamp) of the files.  How does GitHub record
> times, and why?
>
> > ## Solution
