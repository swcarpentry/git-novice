...
Note that our local repository still contains our earlier work on `mars.txt`, but the remote
...
The name `origin` is a local nickname for your remote repository. We could use something else if we
