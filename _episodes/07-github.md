...
> ## HTTPS vs. SSH
>
> We use HTTPS here because it requires less additional configuration.  After
...
Once the remote is set up and we have our authentication token ready, this command
will push the changes from our local repository to the repository on GitHub:
