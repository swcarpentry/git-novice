...
> ## Line Endings
>
> As with other keys, when you hit <kbd>Return</kbd> or <kbd>Enter</kbd> on your keyboard,
...
your changes, press <kbd>Esc</kbd> then type `:q!` and hit <kbd>Return</kbd> or <kbd>Enter</kbd>.
> If you want to save your changes and quit, press <kbd>Esc</kbd> then type `:wq` and hit <kbd>Return</kbd> or <kbd>Enter</kbd>.
{: .callout}
